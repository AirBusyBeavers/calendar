...
const makeReservation = (reservationDetails, cb) => {
  ...
  const query1 = `INSERT INTO checkout.reservations_by_property(reservationID, userID, propertyID, reservationStart, reservationEnd, adults, children, infants) values(?, ?, ?, ?, ?, ?, ?, ?) ;`;
  const query2 = `INSERT INTO checkout.reservations_by_user(reservationID, userID, propertyID, reservationStart, reservationEnd, adults, children, infants) values(?, ?, ?, ?, ?, ?, ?, ?) ;`;
